...
public interface Complexity {
    ...
    String TIME_LOG_N = "O(log{n})";
    String TIME_H = "O(h)";
    String TIME_N = "O(n)";
    String TIME_M_PLUS_N = "O(m+n)";
    String TIME_N_LOG_N = "O(n*log{n})";
    String TIME_M_LOG_N = "O(m*log{n})";
    ...
    String SPACE_LOG_N = "O(log{n})";
    String SPACE_H = "O(h)";
    String SPACE_N = "O(n)";
    String SPACE_M = "O(m)";
    String SPACE_M_PLUS_N = "O(m+n)";
    String SPACE_N_LOG_N = "O(n*log{n})";
    String SPACE_M_LOG_N = "O(m*log{n})";
